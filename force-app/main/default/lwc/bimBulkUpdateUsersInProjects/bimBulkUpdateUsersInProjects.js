...
import insertStagingRecords from "@salesforce/apex/BimBulkUpdateUsersInProjectsController.insertStagingRecords";  
import validateStagingRecords from "@salesforce/apex/BimBulkUpdateUsersInProjectsController.validateStagingRecords";  
import calloutStagingRecords from "@salesforce/apex/BimBulkUpdateUsersInProjectsController.calloutStagingRecords";  

export default class BimBulkUpdateUsersInProjects extends LightningElement {
    ...
    get columns() {
        const columns = [
            ...
            { label: 'User Id', fieldName: 'User Id' },
