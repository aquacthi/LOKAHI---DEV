...
export default class LwcMultiSelectLookup extends LightningElement {
    ...
    @api projectType;  // = 'standard:contact';
    //end---->
    ...
    handleDoneClick(event){        
        console.log(' in handleDoneClick');
        console.log(' in this.globalSelectedItems ' + JSON.stringify(this.globalSelectedItems));
        console.log(' in this.previousSelectedItems ' + JSON.stringify(this.previousSelectedItems));
